package com.walmartlabs.ern.myaboutusapp;

import com.walmartlabs.ern.container.miniapps.MyAboutUsAppActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = MyAboutUsAppActivity.class;
